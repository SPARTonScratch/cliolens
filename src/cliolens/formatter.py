...
class MarkdownFormatter:
    ...
    def format(self, result: ScanResult) -> str:
        ...
        # The header reports the final document's own size, so assemble, measure, reassemble.
        tokens = chars = 0
        for _ in range(2):
            doc = self._render_header(result, tokens, chars) + body
